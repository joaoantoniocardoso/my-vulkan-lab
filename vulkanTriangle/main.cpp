...
#include <optional> // <struct>.has_value()
#include <set>
...
class HelloTriangleApplication {
  ...
  private:
    ...
    void createGraphicsPipeline() {
      ...
      rasterizer.polygonMode = VK_POLYGON_MODE_FILL; //_FILL or _LINE or _POINT
    ...
    void createInstance() {
      ...
      printRequiredInstanceExtensions(extensions);
    ...
    void printRequiredInstanceExtensions(std::vector<const char*> extensions) {
